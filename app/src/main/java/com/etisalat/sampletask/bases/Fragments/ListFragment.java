...
public class ListFragment extends BaseFragment implements MyRecyclerViewAdapter.ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Gson gson = new Gson();
        String json = getArguments().getString("ListData");
        if (json!=null) {
        ...
        mListener.onFragmentInteractionHideProgress();
        Log.d("Fragmentlog", items.get(0).getName()+"");
        return view;
    }
    ...
    public void onItemClick(View view, int position) {
        mListener.onFragmentInteractionItemClicked(items.get(position));
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onFragmentInteractionItemClicked(item item);
        void onFragmentInteractionHideProgress();
    }
}
